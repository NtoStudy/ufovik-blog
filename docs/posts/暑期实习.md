...
在使用vue3开发uniapp中，vue3有一套属于自己的页面声明周期，其中的执行顺序为：setup语法糖，onBeforeMount，onMounted，onBeforeUpdate，onUpdated（注意，这里的onBeforeUpdate和onUpdated仅在H5中生效，并不在其他小程序中生效，），onBeforeUnmount，onUnmounted。这个是被称之为组件的声明周期，由于vue是由大量的.vue文件组成，这些生命周期仅存在于组件之中。针对于uniapp自身的应用生命周期。他们是存在于整个应用中的。其中包括
...
![img](https://blog-pic-1338675647.cos.ap-nanjing.myqcloud.com/blog/202507051457488.jpeg)

详情可看https://uniapp.dcloud.net.cn/tutorial/page.html#lifecycle
